		...
		var Dropdown = function() {
			...
			Dropdown.prototype._getConfig = function _getConfig(config) {
				...
				if (elementData.placement !== undefined) {
					elementData.placement = AttachmentMap[elementData.placement
							.toUpperCase()];
				}
		...
		var Tooltip = function() {
			...
			Tooltip.prototype.hide = function hide(callback) {
				...
				var complete = function complete() {
					...
					$(_this25.element)
							.trigger(_this25.constructor.Event.HIDDEN);
				...
				triggers
						.forEach(function(trigger) {
							if (trigger === 'click') {
								...
								var eventIn = trigger === Trigger.HOVER ? _this26.constructor.Event.MOUSEENTER
										: _this26.constructor.Event.FOCUSIN;
								var eventOut = trigger === Trigger.HOVER ? _this26.constructor.Event.MOUSELEAVE
										: _this26.constructor.Event.FOCUSOUT;

								$(_this26.element).on(eventIn,
										_this26.config.selector,
										function(event) {
							...
							$(_this26.element).closest('.modal').on(
